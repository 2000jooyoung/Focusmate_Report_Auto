...
def generate_일별공부시간(df, name):
    ...
    for pngs, week in zip(일별공부시간들, weeks):
        ...
        make_color_transparent(
            f"{name}/일별공부시간_{week}.png", f"{name}/일별공부시간_{week}.png", "#FFFFFF"
        )
...
def generate_목표시간대비공부시간(df, name):
    ...
    make_color_transparent(
        f"{name}/목표시간대비공부시간.png", f"{name}/목표시간대비공부시간.png", "#FFFFFF"
    )
...
def generate_목표시간대비공부시간_text(target, name):
    ...
    make_color_transparent(
        f"{name}/목표시간대비공부시간_text_middle.png",
        f"{name}/목표시간대비공부시간_text_middle.png",
        "#FFFFFF",
    )
    ...
    make_color_transparent(
        f"{name}/목표시간대비공부시간_text_max.png", f"{name}/목표시간대비공부시간_text_max.png", "#FFFFFF"
    )
