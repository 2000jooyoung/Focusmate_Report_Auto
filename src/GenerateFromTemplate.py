...
class GenerateFromTemplate:
    ...
    def addColoredText(self,text,point, font_family= "NotoSansKR",font_size=25, color=(80, 82, 101)):
    ...
    def addGraphics(self, point, img, scale =1):
        ...
        self.c.drawImage(image=img, x=point[0],y=point[1], width= img_width*scale, height=img_height*scale, mask='auto')